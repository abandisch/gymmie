...
exports.GRAPHQL_URI = 'https://strengthexchange-abandisch.now.sh/graphql';
...
exports.LOGIN_API_URL = 'https://gt-server-abandisch.now.sh/gym-tracker/login';
...
exports.STR_TRCKR_API_URL = 'https://gt-server-abandisch.now.sh/strength-tracker';
